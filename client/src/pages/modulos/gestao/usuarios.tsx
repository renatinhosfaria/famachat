...
const getRolesForDepartment = (department: string): string[] => {
  switch(department) {
    ...
    case Department.SALES:
      return [Role.BROKER_SENIOR, Role.EXECUTIVE, Role.BROKER_JUNIOR, Role.BROKER_TRAINEE]; // Vendas -> Múltiplos cargos
    default:
      return [];
  }
};
            ...
            <div className="py-4 flex flex-col gap-4">
              ...
              <div>
                ...
                <Select value={formData.department} onValueChange={(value) => {
                  ...
                  <SelectContent>
                    <SelectItem value={Department.MANAGEMENT}>Gestão</SelectItem>
                    <SelectItem value={Department.MARKETING}>Marketing</SelectItem>
                    <SelectItem value={Department.SALES}>Vendas</SelectItem>
                    <SelectItem value={Department.CUSTOMER_SERVICE}>Central de Atendimento</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
