    ...
    <>
            ...
            <CardContent>
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="flex items-center gap-2 mt-4">
                  <h2 className="text-xl font-semibold">{typedCliente.fullName}</h2>
                  <Button 
                    variant="ghost" 
                    size="icon" 
                    className="h-6 w-6" 
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Badge variant="outline">{typedCliente.source || "Origem não especificada"}</Badge>
                  <Button 
                    variant="ghost" 
                    size="icon" 
                    className="h-5 w-5" 
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex flex-col">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{typedCliente.phone ? formatPhoneNumber(typedCliente.phone) : "Não informado"}</span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span>CPF: {typedCliente.cpf ? formatCPF(typedCliente.cpf) : "Não informado"}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-medium text-muted-foreground">Interesse</h3>
                  <div className="space-y-3">
                    ...
                    {(typedCliente as any).interestType && (
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span>{(typedCliente as any).interestType}</span>
                        </div>
                        <Button variant="ghost" size="icon" className="h-6 w-6" title="Editar tipo de interesse">
                          <PenLine className="h-3 w-3" />
                        </Button>
                      </div>
                    )}
                    {(typedCliente as any).interest && (
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span>{(typedCliente as any).interest}</span>
                        </div>
                        <Button variant="ghost" size="icon" className="h-6 w-6" title="Editar interesse">
                          <PenLine className="h-3 w-3" />
                        </Button>
                      </div>
                    )}
                    {(typedCliente as any).location && (
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span>{(typedCliente as any).location}</span>
                        </div>
                        <Button variant="ghost" size="icon" className="h-6 w-6" title="Editar localização">
                          <PenLine className="h-3 w-3" />
                        </Button>
                      </div>
                    )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <UserIcon className="h-4 w-4 mr-3 text-muted-foreground" />
                        <span>Consultor de Atendimento: {assignedUser ? assignedUser.username : "Não atribuído"}</span>
                      </div>
                      <Button 
                        variant="ghost" 
                        size="icon" 
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button 
                        variant="ghost" 
                        size="icon" 
                        className="h-6 w-6"                         title="Editar corretor"                        onClick={() => handleEditStart('broker')}
                      >
                        <PenLine className="h-3 w-3" />
                      </Button>
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <Button 
                    className="w-full bg-[#00ABD1] hover:bg-[#0096b7] text-white" 
            ...
            <Card>
              <CardHeader className="pb-3">
                <div className="flex flex-row items-center justify-between mb-4">
                  ...
                  <Button 
                    className="bg-[#00ABD1] hover:bg-[#0096b7] text-white w-full max-w-[220px]"
                        ...
                        if (item.type === 'appointment') {
                          return (
                            <div 
                              ...
                              className="flex flex-col p-3 border rounded-md hover:bg-muted/20 transition-colors"
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <Calendar className="h-5 w-5 text-[#00ABD1]" />
                              ...
                              <div className="ml-7 mt-1">
                                <div className="mt-2">
                                  ...
                                  <p className="text-sm text-muted-foreground">{item.address || item.location || "Local não especificado"}</p>
                                  {item.notes && (
                                    <p className="text-sm mt-1">{item.notes}</p>
                                  )}
                                  <div className="text-xs text-muted-foreground text-right mt-2">
                                    <Calendar className="h-3 w-3 inline mr-1" /> Última atualização: {formatDatePreserveTime(item.updatedAt || item.createdAt)}
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <Home className="h-5 w-5 text-[#00ABD1]" />
                                  <h4 className="font-medium">Visita</h4>
                                </div>
                                <div className="flex items-center gap-1">
                                  <Button 
                                    variant="ghost" 
                              ...
                              <div className="ml-7 mt-1">
                                <div className="mt-2">
                                  ...
                                  <div className="text-xs text-muted-foreground text-right mt-2">
                                    <Calendar className="h-3 w-3 inline mr-1" /> Última atualização: {formatDatePreserveTime(item.updatedAt || item.visitedAt)}
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <h4 className="font-medium">Venda</h4>
                              ...
                              <div className="ml-7 mt-1">
                                <div className="mt-2">
                                  ...
                                  <div className="text-xs text-muted-foreground text-right mt-2">
                                    <Calendar className="h-3 w-3 inline mr-1" /> Última atualização: {formatDatePreserveTime(item.updatedAt || item.soldAt)}
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <PenLine className="h-5 w-5 text-[#00ABD1]" />
                                  <h4 className="font-medium">Anotação</h4>
                                </div>
                                <div className="flex items-center gap-1">
                                  <Button
                                    variant="ghost"
                              ...
                              <div className="ml-7 mt-1">
                                <div className="mt-2">
                                  ...
                                  <div className="text-xs text-muted-foreground text-right mt-2">
                                    <Calendar className="h-3 w-3 inline mr-1" /> Última atualização: {formatDatePreserveTime(item.updatedAt || item.rawDate)}
                                  </div>
                                </div>
                              </div>
                            </div>
      ...
      <Dialog open={editNameDialogOpen} onOpenChange={setEditNameDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditNameDialogOpen(false)}>Cancelar</Button>
            <Button 
      ...
      <Dialog open={editSourceDialogOpen} onOpenChange={setEditSourceDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditSourceDialogOpen(false)}>Cancelar</Button>
            <Button 
      ...
      <Dialog open={editPhoneDialogOpen} onOpenChange={setEditPhoneDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditPhoneDialogOpen(false)}>Cancelar</Button>
            <Button 
      ...
      <Dialog open={editEmailDialogOpen} onOpenChange={setEditEmailDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditEmailDialogOpen(false)}>Cancelar</Button>
            <Button 
      ...
      <Dialog open={editConsultantDialogOpen} onOpenChange={setEditConsultantDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Alterar Consultor</DialogTitle>
            <DialogDescription>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditConsultantDialogOpen(false)}>Cancelar</Button>
            <Button 
      ...
      <Dialog open={editBrokerDialogOpen} onOpenChange={setEditBrokerDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Alterar Corretor</DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              <Label htmlFor="edit-broker">Corretor</Label>
              <Select 
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditBrokerDialogOpen(false)}>Cancelar</Button>
            <Button 
        ...
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={updating}
            >
              {updating ? "Excluindo..." : "Excluir Cliente"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
